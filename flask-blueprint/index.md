...
1. Settle on a development environment that: 1.
         i. Removes the aggravation of Python development in a Windows environment. i.
         ii. Allows me to work locally but can migrate to the cloud effortlessly. ii.
